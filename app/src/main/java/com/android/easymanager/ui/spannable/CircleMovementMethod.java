package com.android.easymanager.ui.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = IxiaApplication.context.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = IxiaApplication.context.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
