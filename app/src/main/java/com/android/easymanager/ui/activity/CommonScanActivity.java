...
import com.android.easymanager.utils.zxing.ScanListener;
//import com.android.easymanager.utils.zxing.ScanManager;
import com.android.easymanager.utils.zxing.decode.Utils;
import com.android.easymanager.utils.zxing.decode.DecodeThread;
                ...
                JMessageClient.getUserInfo(userResult.user.username, userResult.user.appkey, new GetUserInfoCallback() {
                    ...
                    public void gotResult(int i, String s, UserInfo userInfo) {
                        ...
                        if (i == 0) {
                            ...
                            } else if (userInfo.isFriend()) {//扫出来的是好友
                                intent.setClass(CommonScanActivity.this, FriendInfoActivity.class);
                                intent.putExtra(IxiaApplication.TARGET_ID, userInfo.getUserName());
                                intent.putExtra(IxiaApplication.TARGET_APP_KEY, userInfo.getAppKey());
                            ...
                            ToastUtil.shortToast(CommonScanActivity.this,"扫描失败");
                        }
                    }
                });
            } catch (Exception e) {
...
//            startActivity(intent);
            ToastUtil.shortToast(CommonScanActivity.this,"扫描结果显示：jsonUser=="+jsonUser);
        }
    }
