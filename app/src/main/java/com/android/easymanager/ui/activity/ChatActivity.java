...
//    private ArrayList<ImageItem> selImageList; //当前选择的所有图片
    ...
    private void initData() {
        ...
        mTitle = intent.getStringExtra(IxiaApplication.CONV_TITLE);
...
//    }
    ...
    protected void onResume() {
        ...
        if (!mIsSingle) {
            ...
            if (groupId != 0) {
                IxiaApplication.isAtMe.put(groupId, false);
                IxiaApplication.isAtall.put(groupId, false);
        ...
        //历史消息中删除后返回到聊天界面刷新界面
        if (IxiaApplication.ids != null && IxiaApplication.ids.size() > 0) {
            for (Message msg : IxiaApplication.ids) {
